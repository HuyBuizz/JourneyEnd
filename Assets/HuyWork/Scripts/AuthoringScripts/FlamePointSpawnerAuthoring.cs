...
/// </summary>
public class FlamePointSpawnerAuthoring : MonoBehaviour
{
    [Header("Prefab")]
    ...
    class FlamePointSpawnAuthoringBaker : Baker<FlamePointSpawnerAuthoring>
    {
        public override void Bake(FlamePointSpawnerAuthoring authoring)
        {
